...
//  Tarefas:
        Tarefas.BancoDelistasTarefas.add(Tarefas(1,StatusTarefa.PENDENTE, User.listaUser[0],"01/01/2021",Pedido.listasPedido[0],"",R.drawable.tarefa_pendente))
        Tarefas.BancoDelistasTarefas.add(Tarefas(2,StatusTarefa.ATRASADO, User.listaUser[1],"02/01/2021",Pedido.listasPedido[1],"",R.drawable.tarefa_atrasada))
        Tarefas.BancoDelistasTarefas.add(Tarefas(3,StatusTarefa.CANCELADO, User.listaUser[1],"03/01/2021",Pedido.listasPedido[2],"Produto com defeito",R.drawable.tarefa_cancelada))
        Tarefas.BancoDelistasTarefas.add(Tarefas(4,StatusTarefa.ENTREGUE, User.listaUser[0],"04/01/2021",Pedido.listasPedido[3], "",R.drawable.tarefa_entregue))
    }
}